      ...
      <div className="inline-block">
        ...
        <span className="relative hidden md:block" title={`Rating: ${rating}`}>
          <span className="flex flex-row text-gray-300">
            ...
            <i className="top-px inline-block font-icons font-normal not-italic leading-none antialiased before:content-['\e9d9\e9d9\e9d9\e9d9\e9d9\e9d9\e9d9\e9d9\e9d9\e9d9']" />
          </span>
          <span
