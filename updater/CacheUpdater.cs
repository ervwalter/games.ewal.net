...
namespace GamesCacheUpdater
{
    public class CacheUpdater
    {
        ...
        public CacheUpdater(IConfiguration configuration)
        {
        ...
        {
            _storage = CloudStorageAccount.Parse(_configuration.GetConnectionString("CacheStorage"));
            ...
            _username = _configuration.GetSection("bggCredentials")["username"];
            _password = _configuration.GetSection("bggCredentials")["password"];
        ...
        public async Task LoadCachedGameDetails()
        {
